# -*- coding: utf-8 -*-
#
# Pykickstart documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.viewcode', 'versionremoved']
...
htmlhelp_basename = 'Pykickstartdoc'
...
latex_documents = [
  ('index', 'Pykickstart.tex', u'Pykickstart Documentation',
...
man_pages = [
    ('index', 'pykickstart', u'Pykickstart Documentation',
     [u'Anaconda Team'], 1)
]
...
texinfo_documents = [
  ('index', 'Pykickstart', u'Pykickstart Documentation',
   u'Anaconda Team', 'Pykickstart', 'One line description of project.',
   'Miscellaneous'),
]
