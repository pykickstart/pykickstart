...
check:
	...
	PYTHONPATH=. pylint pykickstart/*.py pykickstart/*/*.py --msg-template='{msg_id}:{line:3d},{column}: {obj}: {msg}' --rcfile=/dev/null -r n --disable=C,R --disable=W0110,W0141,W0142,W0221,W0603,W0611,W0612,W0613,W0614,W0703
