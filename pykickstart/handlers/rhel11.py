...
#
__all__ = ["RHEL11Handler"]

from pykickstart import commands
from pykickstart.base import BaseHandler
from pykickstart.version import RHEL11

class RHEL11Handler(BaseHandler):
    version = RHEL11
    ...
    commandMap = {
        ...
        "part": commands.partition.RHEL11_Partition,
        "partition": commands.partition.RHEL11_Partition,
