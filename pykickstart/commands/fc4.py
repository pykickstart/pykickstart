...
class FC4Handler(BaseHandler):
    def __init__(self):
        ...
        self._registerHandler(CommandAuthconfig(), ["auth", "authconfig"])
        self._registerHandler(CommandAutoPart(), ["autopart"])
        self._registerHandler(CommandAutoStep(), ["autostep"])
        self._registerHandler(CommandBootloader(), ["bootloader"])
        self._registerHandler(CommandMethod(), ["cdrom", "harddrive", "nfs", "url"])
        self._registerHandler(CommandClearPart(), ["clearpart"])
        self._registerHandler(CommandDisplayMode(), ["cmdline", "graphical", "text"])
        self._registerHandler(CommandDevice(), ["device"])
        self._registerHandler(CommandDeviceProbe(), ["deviceprobe"])
        self._registerHandler(CommandDriverDisk(), ["driverdisk"])
        self._registerHandler(CommandFirewall(), ["firewall"])
        self._registerHandler(CommandFirstboot(), ["firstboot"])
        self._registerHandler(CommandReboot(), ["halt", "poweroff", "reboot", "shutdown"])
        self._registerHandler(CommandIgnoreDisk(), ["ignoredisk"])
        self._registerHandler(CommandInteractive(), ["interactive"])
        self._registerHandler(CommandKeyboard(), ["keyboard"])
        self._registerHandler(CommandLang(), ["lang"])
        self._registerHandler(CommandLangSupport(), ["langsupport"])
        self._registerHandler(CommandLogVol(), ["logvol"])
        self._registerHandler(CommandMediaCheck(), ["mediacheck"])
        self._registerHandler(CommandMonitor(), ["monitor"])
        self._registerHandler(CommandMouse(), ["mouse"])
        self._registerHandler(CommandNetwork(), ["network"])
        self._registerHandler(CommandPartition(), ["part", "partition"])
        self._registerHandler(CommandRaid(), ["raid"])
        self._registerHandler(CommandRootPw(), ["rootpw"])
        self._registerHandler(CommandSELinux(), ["selinux"])
        self._registerHandler(CommandSkipX(), ["skipx"])
        self._registerHandler(CommandTimezone(), ["timezone"])
        self._registerHandler(CommandUpgrade(), ["upgrade", "install"])
        self._registerHandler(CommandVnc(), ["vnc"])
        self._registerHandler(CommandVolGroup(), ["volgroup"])
        self._registerHandler(CommandXConfig(), ["xconfig"])
        self._registerHandler(CommandZeroMbr(), ["zerombr"])
        self._registerHandler(CommandZFCP(), ["zfcp"])
