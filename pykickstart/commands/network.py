...
from pykickstart.version import versionToLongString, RHEL4, RHEL5, RHEL6, RHEL7, RHEL9
...
class RHEL9_NetworkData(F27_NetworkData):
...
class RHEL9_Network(F27_Network):
    removedKeywords = F27_Network.removedKeywords
    removedAttrs = F27_Network.removedAttrs

    def _getParser(self):
        op = F27_Network._getParser(self)
        op.add_argument("--ipv4-dns-search", default=None, version=RHEL9, dest="ipv4_dns_search",
                        help="""
        ...
        op.add_argument("--ipv6-dns-search", default=None, version=RHEL9, dest="ipv6_dns_search",
                        help="""
                        Use this option to set IPv6 search domains. For example: ``--ipv6-dns-search domain1.example.com,domain2.example.com``
                        Requires ``--device`` to be specified.""")
        op.add_argument("--ipv4-ignore-auto-dns", action="store_true", version=RHEL9,
                        dest="ipv4_ignore_auto_dns", help="""
                        Use this option to ignore IPv4 automatic DNS.
                        Requires ``--device`` to be specified.""")
        op.add_argument("--ipv6-ignore-auto-dns", action="store_true", version=RHEL9,
