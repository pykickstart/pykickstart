...
class RHEL7_TestCase(CommandTest):
    ...
    def runTest(self):
        ...
        self.assert_parse_error("mount /dev/sda1", KickstartValueError)
        self.assert_parse_error("mount /boot", KickstartValueError)
        self.assert_parse_error("mount /dev/sda1 /boot --mkfsoptions=\"-L BOOT\"", KickstartValueError)
