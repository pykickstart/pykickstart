...
class StringToVersion_TestCase(CommandTest):
    def runTest(self):
        ...
        # pass - F35
        self.assertEqual(stringToVersion("Fedora 35"), F35)
        self.assertEqual(stringToVersion("F35"), F35)
        # pass - F36
        self.assertEqual(stringToVersion("Fedora 36"), F36)
        self.assertEqual(stringToVersion("F36"), F36)
        # pass - F37
        self.assertEqual(stringToVersion("Fedora 37"), F37)
        self.assertEqual(stringToVersion("F37"), F37)
        # pass - F38
        self.assertEqual(stringToVersion("Fedora 38"), F38)
        self.assertEqual(stringToVersion("F38"), F38)
        # pass - F39
        self.assertEqual(stringToVersion("Fedora 39"), F39)
        self.assertEqual(stringToVersion("F39"), F39)
        # pass - F40
        self.assertEqual(stringToVersion("Fedora 40"), F40)
        self.assertEqual(stringToVersion("F40"), F40)
        # pass - F41
        self.assertEqual(stringToVersion("Fedora 41"), F41)
        self.assertEqual(stringToVersion("F41"), F41)
        # pass - F42
        self.assertEqual(stringToVersion("Fedora 42"), F42)
        self.assertEqual(stringToVersion("F42"), F42)
        # pass - F43
        self.assertEqual(stringToVersion("Fedora 43"), F43)
        self.assertEqual(stringToVersion("F43"), F43)
        # pass - F44
        self.assertEqual(stringToVersion("Fedora 44"), F44)
        self.assertEqual(stringToVersion("F44"), F44)
        # pass - F45
        self.assertEqual(stringToVersion("Fedora 45"), F45)
        self.assertEqual(stringToVersion("F45"), F45)
        ...
        # pass - RHEL10
        self.assertEqual(stringToVersion("Red Hat Enterprise Linux 10"), RHEL10)
        for MINOR in range(1,10):
            self.assertEqual(stringToVersion("Red Hat Enterprise Linux 10.%s" % MINOR), RHEL10)
        self.assertEqual(stringToVersion("RHEL10"), RHEL10)

        # pass - RHEL11
        self.assertEqual(stringToVersion("Red Hat Enterprise Linux 11"), RHEL11)
        for MINOR in range(1,10):
            self.assertEqual(stringToVersion("Red Hat Enterprise Linux 11.%s" % MINOR), RHEL11)
        self.assertEqual(stringToVersion("RHEL11"), RHEL11)
...
class VersionToString_TestCase(CommandTest):
    def runTest(self):
        ...
        self.assertEqual(versionToString(F35, skipDevel=True), "F35")
        self.assertEqual(versionToString(F36, skipDevel=True), "F36")
        self.assertEqual(versionToString(F37, skipDevel=True), "F37")
        self.assertEqual(versionToString(F38, skipDevel=True), "F38")
        self.assertEqual(versionToString(F39, skipDevel=True), "F39")
        self.assertEqual(versionToString(F40, skipDevel=True), "F40")
        self.assertEqual(versionToString(F41, skipDevel=True), "F41")
        self.assertEqual(versionToString(F42, skipDevel=True), "F42")
        self.assertEqual(versionToString(F43, skipDevel=True), "F43")
        self.assertEqual(versionToString(F44, skipDevel=True), "F44")
        self.assertEqual(versionToString(F45, skipDevel=True), "F45")
        self.assertEqual(versionToString(F45, skipDevel=False), "DEVEL")
        # RHEL series
        ...
        self.assertEqual(versionToString(RHEL10), "RHEL10")
        self.assertEqual(versionToString(RHEL11), "RHEL11")
...
class IsRHEL_TestCase(CommandTest):
    def runTest(self):
        ...
        self.assertTrue(isRHEL(RHEL10))
        self.assertTrue(isRHEL(RHEL11))
